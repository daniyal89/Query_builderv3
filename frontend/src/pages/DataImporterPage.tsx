/**
 * DataImporterPage.tsx — Local folder merge page.
 */
      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        <div className="grid gap-6">
          ...
          <div>
            ...
            <p className="mt-2 text-xs text-gray-500">Use .csv for very large merges or .xlsx when Excel output is needed.</p>
          </div>
