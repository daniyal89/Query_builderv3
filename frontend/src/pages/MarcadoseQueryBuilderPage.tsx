        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-6">
            ...
            <p className="mt-2 max-w-3xl text-sm text-gray-500">
              Marcadose uses a read-only Oracle connection. The backend now validates Oracle queries server-side before
              execution.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
              <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
                ...
                <p className="mt-4 text-sm text-gray-500">
                  Save Oracle credentials and connect to load Marcadose tables. Once connected, this page will switch
                  into the query builder workspace automatically.
                </p>
              </div>
